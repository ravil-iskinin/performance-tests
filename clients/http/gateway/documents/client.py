...
class DocumentsGatewayHTTPClient(HTTPClient):
    ...
    def get_tariff_document_api(self, account_id: str) -> Response:
        ...
        return self.get(
            ...
            extensions=HTTPClientExtensions(route=f"{APIRoutes.DOCUMENTS}/tariff-document/{{account_id}}") # Явно передаём логическое имя маршрута
        )
    ...
    def get_contract_document_api(self, account_id: str) -> Response:
        ...
        return self.get(
            ...
            extensions = HTTPClientExtensions(route=f"{APIRoutes.DOCUMENTS}/contract-document/{{account_id}}") # Явно передаём логическое имя маршрута
        )
